  ...
  getAll() {
    return [
      ...
      },
      {
        ...
        icon: "apps",
        items: [
          { link: "/user/adduser", label: this.translate.instant("Add User") },
          { link: "/user/userdetails", label: this.translate.instant("User Details") },
        ]
      },
      {
        label: this.translate.instant("Lead"),
        icon: "equalizer",
        items: [
          { link: "/lead/addlead", label: this.translate.instant("Add Lead") },
          { link: "/lead/leaddetails", label: this.translate.instant("Lead Details") },
        ]
      },
      // {
      //   link: "/widgets",
